...
rate me popupbox
==========================-->
<div class="popup-reset-open">
    <div class="popup-base">
        <div class="popup-rateme-main">
            <div class="row">
                <p class="text-center text-popup-email">Do you want to save changes ?</p>
                <button class="btn btn-info reset-btn">Yes</button>
                <button class="btn btn-info reset-btn close">No</button>
            </div>
        </div>
